...
function FormularioMiembro() {
  ...
  const referenceIsValid =
    referenceRef?.current?.value === "Conocido" ||
    referenceRef?.current?.value === "Instagram" ||
      ...
      <form ref={formRef} className={styles.form} onSubmit={submitHandler}>
        ...
        <label>
          ...
          <select
            ...
            ref={referenceRef}
            onChange={e => setReferenceSelect(e.target.value)}
            defaultValue={"none"}
